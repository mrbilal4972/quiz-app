...
interface Column {
  ...
  function createData(Q_No: number, Your_Answer: string, Correct_Answer: string): Data {
    // const density = population / size;
    return { Q_No, Your_Answer, Correct_Answer };
  }
  
  const rows = [
    createData(1, 'China', 'CN'),
    createData(2,'China', 'CN'),
...
const Score: React.FC<ScorePropsType> = ({score, clickHandler}) => {
